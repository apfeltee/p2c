...
#ifdef DEFDUMPS
static const char* meaningkindnames[(int)MK_LAST]
= { "MK_NONE",   "MK_SPECIAL", "MK_MODULE", "MK_FUNCTION", "MK_CONST", "MK_VAR",
    "MK_TYPE",   "MK_FIELD",   "MK_LABEL",  "MK_VARIANT",  "MK_PARAM", "MK_VARPARAM",
    "MK_VARREF", "MK_VARMAC",  "MK_SPVAR",  "MK_SYNONYM" };
#endif /*DEFDUMPS*/

typedef struct S_paren Paren;
typedef struct S_meaning Meaning;
...
struct S_meaning
{
    ...
    dummy18 : 1, dummy19 : 1, dummy20 : 1, dummy21 : 1, dummy22 : 1, dummy23 : 1, dummy24 : 1,
    dummy25 : 1, dummy26 : 1, dummy27 : 1, dummy28 : 1, dummy29 : 1, dummy30 : 1, dummy31 : 1;
    Value val; /* (above) */
...
#ifdef DEFDUMPS
static const char* typekindnames[(int)TK_LAST]
= { "TK_NONE",     "TK_INTEGER", "TK_CHAR",     "TK_BOOLEAN", "TK_REAL",     "TK_VOID",
    "TK_SUBR",     "TK_ENUM",    "TK_POINTER",  "TK_STRING",  "TK_RECORD",   "TK_ARRAY",
    "TK_SET",      "TK_FILE",    "TK_FUNCTION", "TK_PROCPTR", "TK_SMALLSET", "TK_SMALLARRAY",
    "TK_CPROCPTR", "TK_SPECIAL", "TK_BIGFILE" };
#endif /*DEFDUMPS*/
...
#ifdef DEFDUMPS
static const char* exprkindnames[(int)EK_LAST]
= { "EK_EQ",     "EK_NE",       "EK_LT",          "EK_GT",       "EK_LE",       "EK_GE",
    "EK_PLUS",   "EK_NEG",      "EK_TIMES",       "EK_DIVIDE",   "EK_DIV",      "EK_MOD",
    "EK_OR",     "EK_AND",      "EK_NOT",         "EK_BAND",     "EK_BOR",      "EK_BXOR",
    "EK_BNOT",   "EK_LSH",      "EK_RSH",         "EK_HAT",      "EK_INDEX",    "EK_CAST",
    "EK_DOT",    "EK_COND",     "EK_ADDR",        "EK_SIZEOF",   "EK_ACTCAST",  "EK_CONST",
    "EK_VAR",    "EK_FUNCTION", "EK_ASSIGN",      "EK_POSTINC",  "EK_POSTDEC",  "EK_CHECKNIL",
    "EK_MACARG", "EK_BICALL",   "EK_STRUCTCONST", "EK_STRUCTOF", "EK_COMMA",    "EK_LONGCONST",
    "EK_NAME",   "EK_CTX",      "EK_SPCALL",      "EK_LITCAST",  "EK_TYPENAME", "EK_NEW",
    "EK_DELETE" };
#endif /*DEFDUMPS*/
...
#ifdef DEFDUMPS
static const char* stmtkindnames[(int)SK_LAST]
= { "SK_ASSIGN", "SK_RETURN", "SK_CASE",      "SK_CASELABEL", "SK_IF",  "SK_FOR",
    "SK_REPEAT", "SK_WHILE",  "SK_BREAK",     "SK_CONTINUE",  "SK_TRY", "SK_GOTO",
    "SK_LABEL",  "SK_HEADER", "SK_CASECHECK", "SK_BODY" };
#endif /*DEFDUMPS*/
...
extern enum langenum_t which_lang;
...
extern int sizeof_char, sizeof_short, sizeof_integer, sizeof_pointer, sizeof_double, sizeof_float,
sizeof_enum, sizeof_int, sizeof_long;
...
extern FILE *inf, *outf, *codef, *hdrf, *logfh;
...
*/
        ...
        #define ALLOC(N, TYPE, NAME) \
            ( \
                (alloctemp = (TYPE*)malloc((unsigned)((N) * sizeof(TYPE)))), \
                (alloctemp ? (TYPE*)alloctemp : (TYPE*)outmem()) \
            )

        #define ALLOCV(N, TYPE, NAME) \
            ( \
                (alloctemp = (TYPE*)malloc((unsigned)(N))), \
                (alloctemp ? (TYPE*)alloctemp : (TYPE*)outmem()) \
            )

        #define REALLOC(P, N, TYPE) \
            ( \
                (alloctemp = (TYPE*)realloc((char*)(P), (unsigned)((N) * sizeof(TYPE)))), \
                (alloctemp ? (TYPE*)alloctemp : (TYPE*)outmem()) \
            )
