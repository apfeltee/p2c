...
int main(int argc, char** argv)
{
    ...
    *hdrfname = 0;
    ...
    if(*infname && strcmp(infname, "-"))
    {
        ...
        {
            fprintf(stderr, "What is wrong with this picture? (infname(%d)=\"%s\")\n", strlen(infname), infname);
