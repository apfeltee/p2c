...
$homedir = "/home/Sebastian/Desktop/p2c/home";
$incdir = "/home/Sebastian/Desktop/p2c/home/p2c";
$libdir = "/home/Sebastian/Desktop/p2c/home";
...
foreach (@p2cfiles) {
  ...
  if (!($opts =~ / -H/) && (-f "$homedir/p2crc")) {
    $opts = " -H /home/Sebastian/Desktop/p2c/home$opts";
  }
  $cmd = "$p2ccommand$opts";
  $verbose && print "$cmd\n";
  $res = system($cmd);
